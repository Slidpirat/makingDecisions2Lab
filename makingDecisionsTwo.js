...
//'' //`` It took me forever to figure this out but a simple yet important part
...
switch(letterGrade) {
  case 'A', 'a': console.log('The student is doing excellently.');
  break;
  case 'B', 'b': console.log('The student is doing well.');
  break;
  case 'C', 'c': console.log('The student is doing aaaiiiight.');
  break;
  case 'D', 'd': console.log('The student is not doing very well.');
  break;
  case 'F', 'f': console.log('The student is a failure.');
  break;
  default: console.log('Not an eligible grade.')
}

//// I compensated for all mildy incompitent typists such as myself, who are bad at using the shift key. //// 
